  ...
  return (
    <div className=' h-screen p-4 md:px-6 px-8 rounded-lg w-full bg-[#6c4869] shadow-2xl shadow-black border border-[#ff9634]'>
        ...
        <form action="" className='shadow-lg shadow-black border border-[#ff9634] px-8 py-10 rounded-lg '>
            ...
            <textarea type="text" className='px-6  h-44 w-2/3 py-4 rounded-lg  placeholder:text-white placeholder:text-center placeholder:text-lg bg-[#ffffff84]' placeholder='Give your Feedback here' />
